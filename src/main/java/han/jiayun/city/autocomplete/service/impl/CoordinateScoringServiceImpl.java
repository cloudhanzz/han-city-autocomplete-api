...
public class CoordinateScoringServiceImpl implements CoordinateScoringService {
	...
	/*
	 * These are just heuristics. In real application, machine learning is needed to
	 * calculate these values.. Here is only for the sake of simplicity.
	 */
	@Override
	public double toScore(double distance) {
